...
INSERT INTO "new_Jabatan" ("createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "level", "namaJabatan", "opdId", "parentId", "pelaksanaId", "updatedAt") SELECT "createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "level", "namaJabatan", "opdId", "parentId", "pelaksanaId", "updatedAt" FROM "Jabatan";
DROP TABLE "Jabatan";
