...
CREATE TABLE "new_Jabatan" (
    ...
    "kategoriJabatan" TEXT NOT NULL DEFAULT 'TEKNIS',
    "statusJabatan" TEXT NOT NULL DEFAULT 'definitif',
    "parentId" INTEGER,
    ...
    CONSTRAINT "Jabatan_pelaksanaId_fkey" FOREIGN KEY ("pelaksanaId") REFERENCES "RefPelaksana" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Jabatan" ("createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "kategoriJabatan", "level", "namaJabatan", "opdId", "parentId", "pelaksanaId", "updatedAt") SELECT "createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "kategoriJabatan", "level", "namaJabatan", "opdId", "parentId", "pelaksanaId", "updatedAt" FROM "Jabatan";
DROP TABLE "Jabatan";
