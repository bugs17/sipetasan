/*
  ...
  - You are about to drop the column `tahunKebutuhan` on the `Pegawai` table. All the data in the column will be lost.
  - You are about to drop the column `tahunPensiun` on the `Pegawai` table. All the data in the column will be lost.
...
INSERT INTO "new_Pegawai" ("createdAt", "id", "jabatanId", "nama", "nip", "opdId", "pendidikanId", "tanggalLahir", "tempatLahir", "updatedAt") SELECT "createdAt", "id", "jabatanId", "nama", "nip", "opdId", "pendidikanId", "tanggalLahir", "tempatLahir", "updatedAt" FROM "Pegawai";
DROP TABLE "Pegawai";
