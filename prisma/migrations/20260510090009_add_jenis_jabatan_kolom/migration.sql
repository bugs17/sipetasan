-- CreateTable
CREATE TABLE "RefPelaksana" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "namaJenjang" TEXT NOT NULL
);
...
INSERT INTO "new_Jabatan" ("createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "level", "namaJabatan", "opdId", "parentId", "updatedAt") SELECT "createdAt", "eselonId", "fungsionalId", "id", "jenisJabatan", "kJ", "level", "namaJabatan", "opdId", "parentId", "updatedAt" FROM "Jabatan";
DROP TABLE "Jabatan";
