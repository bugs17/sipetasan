/*
  ...
  - You are about to drop the column `statusKeluar` on the `Pegawai` table. All the data in the column will be lost.
  - You are about to drop the column `tahunKeluar` on the `Pegawai` table. All the data in the column will be lost.
