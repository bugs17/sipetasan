              ...
              <table className="w-full text-left border-collapse table-fixed">
                <thead>
                  <tr className="border-b border-white/10 bg-white/[0.03]">
                    <th className="w-[50%] p-3 text-[9px] font-black text-gray-400 uppercase tracking-widest">
                      Jabatan
                    </th>
                    <th className="w-[10%] p-2 text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">
                      KJ
                    </th>
                    <th className="w-[10%] p-2 text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">
                      B
                    ...
                    <th className="w-[20%] p-2 text-[9px] font-black text-gray-400 uppercase tracking-widest text-center">
                      +/-
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-white/[0.05]">
                  {jabatan.map((item, index) => {
                    const selisih =
                      item._count.pegawai -
                      Math.round(item.totalKebutuhanPegawai);
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-2 text-center text-[10px] font-mono text-gray-400">
                          {item.kJ}
                        </td>
                        <td className="p-2 text-center text-[10px] font-bold text-gray-300">
                          {item._count.pegawai}
                        </td>
                        <td className="p-2 text-center text-[10px] font-bold text-gray-300">
                          {Math.round(item.totalKebutuhanPegawai)}
                        ...
                        <td className="p-2 text-center">
                          <span
                            className={`inline-block min-w-[35px] text-[9px] font-black px-1.5 py-0.5 rounded-md ${
                              selisih < 0
