...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#212126] text-white selection:bg-[#6d28d9]/30 flex items-center justify-center p-6 overflow-hidden relative">
        ...
        >
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-sm font-bold text-white tracking-tight">
              Tracking <span className="text-gray-400 font-medium italic mx-0.5">Status</span>
            </span>
          </div>
      ...
      <div className={`fixed inset-0 z-[110] transition-visibility ${isDrawerOpen ? 'visible' : 'invisible'}`}>
        {/* Backdrop */}
        <div 
        ...
        {/* Drawer Content */}
        <div className={`absolute top-0 left-0 h-full w-full max-w-md bg-[#1a1a1e] border-r border-white/10 shadow-2xl transition-transform duration-500 transform ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          <div className="p-8 flex flex-col h-full relative overflow-hidden">
            ...
            <div className="relative z-10 mt-10">
              <h2 className="text-3xl font-black italic tracking-tighter">TRACKING <span className="text-[#6d28d9]">STATUS.</span></h2>
              <p className="text-gray-500 text-xs font-bold uppercase tracking-[0.2em] mt-2">Monitoring Usulan ASN</p>
            </div>

            {/* Input Section */}
            <div className="relative z-10 mt-12 space-y-4">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Nomor Induk Pegawai (NIP)</label>
            ...
            <div className="relative z-10 mt-12 flex-1 overflow-y-auto">
              {statusResult ? (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="p-6 rounded-3xl bg-white/[0.03] border border-white/10 space-y-4">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="text-[10px] font-black text-[#6d28d9] uppercase tracking-widest">Nama Pegawai</p>
                        <h4 className="text-sm font-bold mt-1 uppercase">{statusResult.nama}</h4>
                      </div>
                      <div className="px-2 py-1 rounded-md bg-[#6d28d9]/20 border border-[#6d28d9]/30">
                        <span className="text-[10px] font-black text-[#6d28d9]">{statusResult.status}</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 pt-4 border-t border-white/5">
                      <div className="flex gap-4">
                        ...
                        <div>
                          <p className="text-[10px] font-black text-gray-500 uppercase">Posisi Terakhir</p>
                          <p className="text-[11px] font-medium text-gray-300">{statusResult.posisi}</p>
                          <p className="text-[9px] text-gray-600 mt-1">{statusResult.update}</p>
                        </div>
                      </div>
                    </div>

                    <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                      <p className="text-[10px] font-bold text-gray-400 italic">"{statusResult.note}"</p>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="h-full flex flex-col items-center justify-center opacity-20 grayscale">
                   ...
                   <p className="text-[10px] font-black uppercase tracking-widest mt-4 text-center">Belum ada data<br/>yang diperiksa</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
          <div className="space-y-4 md:space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="text-[11px] font-bold text-gray-300 uppercase tracking-[0.2em]">Versi {process.env.NEXT_PUBLIC_APP_VERSION}</span>
            </div>
            ...
            <div className="flex flex-row items-center justify-start gap-4 md:gap-8 pt-4 py-4 border-y border-white/5 md:border-none">
              <div className="group flex flex-col">
                <div className="flex items-baseline gap-0.5 transition-transform group-hover:scale-105 duration-300">
                  <span className="text-xl md:text-3xl font-black text-white tracking-tighter">12.402</span>
                  <span className="text-[#6d28d9] font-bold text-lg">+</span>
                </div>
                <span className="text-[8px] md:text-[9px] text-gray-500 uppercase tracking-widest font-black">Pegawai</span>
              </div>
              ...
              <div className="group flex flex-col">
                <div className="flex items-baseline gap-0.5 transition-transform group-hover:scale-105 duration-300">
                  <span className="text-xl md:text-3xl font-black text-white tracking-tighter">48</span>
                  <span className="text-[#6d28d9] font-bold text-lg">+</span>
                </div>
                <span className="text-[8px] md:text-[9px] text-gray-500 uppercase tracking-widest font-black">Instansi</span>
              </div>
              ...
              <div className="group flex flex-col">
                <div className="flex items-baseline gap-0.5 transition-transform group-hover:scale-105 duration-300">
                  <span className="text-xl md:text-3xl font-black text-[#6d28d9] tracking-tighter">0</span>
                  <span className="text-white/50 font-bold text-lg">+</span>
                </div>
                <span className="text-[8px] md:text-[9px] text-gray-500 uppercase tracking-widest font-black">Anjab/Mutasi</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-white/5 space-y-3">
            <p className="text-[9px] text-gray-500 uppercase tracking-[0.3em] font-bold">Dikelola Oleh</p>
            <div className="flex items-center gap-6 opacity-60">
              <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all duration-500">
                <img src="/logo-provinsi.svg" alt="Logo Pemprov Papua" className="h-8 w-auto" />
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold leading-none">PEMPROV</span>
                  <span className="text-[8px] text-gray-500 font-medium">PAPUA</span>
                </div>
              </div>
              <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all duration-500">
                <img src="/logo-komdigi.svg" alt="Logo Komdigi" className="h-7 w-auto" />
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold leading-none">DISKOMINFO</span>
                  <span className="text-[8px] text-gray-500 font-medium">PROV. PAPUA</span>
                </div>
              </div>
            </div>
          </div>
