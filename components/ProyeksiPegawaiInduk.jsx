...
//   // Data instansi dengan ikon yang lebih bertema "Data/Proyeksi"
...
//       {/* Grid - Glassmorphism Style */}
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//         {instansiProyeksi.map((item) => (
//           <button
//             key={item.id}
...
//               {/* Icon Box */}
//               <div 
//                 className="p-4 rounded-2xl bg-[#212126] border border-white/5 transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]"
...
//               {/* Status Badge */}
//               <div className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[9px] font-bold text-gray-500 group-hover:text-white transition-colors">
//                 AKTIF
//               </div>
//             </div>
...
//                 Klik untuk melihat detail estimasi formasi dan alokasi anggaran pegawai.
//               </p>
//             </div>
