...
const MutasiIduk = () => {
  ...
  const [allData, setAllData] = useState([
    {
      ...
      dokumen: [
        ...
        {
          id: "d3",
          nama: "Surat Bebas Temuan",
          file: "bebas_temuan.pdf",
          status: "idle",
        },
      ],
    },
    {
      ...
      dokumen: [
        ...
        },
        {
          id: "d2",
          nama: "SK Pangkat Terakhir",
          file: "sk_pangkat_andi.pdf",
          status: "approved",
        },
        {
          id: "d3",
          nama: "Surat Bebas Temuan",
          file: "bebas_temuan_andi.pdf",
          status: "approved",
        },
      ],
    },
    {
      ...
      status: "rejected",
      catatanAdmin:
        "Formasi pada OPD tujuan sudah penuh untuk tahun anggaran ini.",
      dokumen: [
        {
          id: "d1",
          nama: "Surat Permohonan",
    ...
    },
    {
      ...
      status: "revised",
      catatanAdmin:
        "SK Pangkat Terakhir yang diunggah sudah kadaluarsa, mohon unggah SK terbaru.",
      dokumen: [
        {
          id: "d1",
          nama: "Surat Permohonan",
        ...
        },
        {
          id: "d2",
          nama: "SK Pangkat Terakhir",
          file: "sk_pangkat_old.pdf",
          status: "revised",
        },
        {
          id: "d3",
          nama: "Surat Bebas Temuan",
          file: "bebas_rizky.pdf",
          status: "approved",
        },
      ],
    },
  ...
  const anyDocRevised =
    selectedRequest &&
    selectedRequest.dokumen.some((doc) => documentStatus[doc.id] === "revised");
                    ...
                    >
                      <div className="mb-1">
                        ...
                        {item.status === "pending" && (
                          <Clock
                            size={20}
                            className="text-[#6d28d9] animate-pulse"
                          />
                        )}
                      </div>
                  ...
                  >
                    ...
                    {selectedRequest.status === "pending" && (
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        <button
                          onClick={(e) =>
                            toggleDocStatus(e, doc.id, "approved")
                          }
              ...
              {activeDocData ? (
                <>
                  ...
                  <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 px-6 py-3 bg-black/60 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl transition-all hover:border-[#6d28d9]/30">
                    ...
                    <a
                      href={`#`} // Pastikan path file sesuai dengan di folder public
