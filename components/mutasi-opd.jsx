        ...
        {isLoading ? (
          ...
          <div className="h-full w-full grid grid-cols-12 gap-6 overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-6 flex-1 content-start">
                  ...
                  <div className="col-span-2 space-y-2">
                    ...
                    <textarea
                      ...
                      placeholder="Jelaskan alasan mutasi secara mendetail..."
                      className="w-full bg-white/[0.03] border border-white/10 rounded-xl py-3.5 px-4 text-xs text-white focus:outline-none focus:border-[#6d28d9]/50 transition-all resize-none"
                    ></textarea>
                  </div>
                </div>
              </div>
            ...
            <div className="col-span-4 h-full flex flex-col">
              <div className="bg-[#1a1a1e]/40 backdrop-blur-2xl border border-white/10 p-8 rounded-[2.5rem] shadow-2xl h-full flex flex-col">
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest mb-6 shrink-0">
                  Persyaratan Dokumen
                </h4>
                    ...
                    <div key={idx} className="group relative">
                      <div className="flex items-center justify-between p-4 bg-white/[0.02] border border-dashed border-white/10 rounded-2xl group-hover:bg-[#6d28d9]/5 group-hover:border-[#6d28d9]/30 transition-all">
                        <div className="flex items-center gap-3">
                          <FileText
                            size={18}
                            className="text-gray-500 group-hover:text-[#6d28d9]"
                          />
                ...
                <button className="w-full mt-6 py-4 bg-[#6d28d9] hover:bg-[#7c3aed] text-white rounded-2xl flex items-center justify-center gap-3 transition-all shadow-lg shadow-[#6d28d9]/20 shrink-0 uppercase tracking-[0.2em] text-[10px] font-black">
                  Kirim Pengajuan <Send size={14} />
                </button>
              </div>
            </div>
          </div>
